...
const Home = () => {
  ...
  return (
    <section className="min-h-screen flex flex-col items-center text-white text-sm px-4 font-poppins">
      ...
      <div className="flex flex-col items-center flex-grow">
        ...
        <p className="text-center text-base max-w-md mt-2">
          Create, customize and publish website faster then ever with our AI Site
          Builder.
        </p>
